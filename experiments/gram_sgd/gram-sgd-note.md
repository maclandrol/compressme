...
These identities should not be presented as a new discovery. [Gunasekar et al. (2017)](https://papers.nips.cc/paper_files/paper/2017/file/58191d2a914c6dae66371c9dcdc91b41-Paper.pdf) explicitly use a positive-semidefinite block lift of rectangular matrix factorization and study factor-independent gradient-flow dynamics. [Arora, Cohen and Hazan (2018)](https://arxiv.org/abs/1802.06509) study effective end-to-end preconditioning from linear overparameterization, with balanced-initialization and gradient-flow assumptions in their main derivation. [Tarmoun et al. (2021)](https://proceedings.mlr.press/v139/tarmoun21a.html) study Gramian and Riccati-type dynamics for overparameterized linear models. Their continuous-time conclusions should not be conflated with the finite-step identities checked here. A broader priority search remains necessary before any novelty claim.
