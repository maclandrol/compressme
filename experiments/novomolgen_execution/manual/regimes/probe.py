...
def main():
    ...
    result = {"method": "first_layer_finite_qkv_research", "device": args.device,
        ...
        "table_policy": "Original per-token QKV tables for total tokens1,2-15,16+ on MPS; a tested backend-specific dispatch hypothesis",
        "bulk_table_values": candidate._first_qkv_rows.numel(),
        "singleton_table_values": candidate._first_qkv_singleton_rows.numel(),
        "small_table_values": candidate._first_qkv_small_rows.numel(),
